...
export function bindWasmZero(wasm: any) {
  ...
  return {
    wasm,
    get_adult_person(): Person { return call("__wasm_zero_get_adult_person", 32, (dv, u8, p) => decode_Person(dv, u8, p), null, null, null); },
    greet(): string { return call("__wasm_zero_greet", 8, (dv, u8, p) => rdStr(dv, u8, p), null, null, null); },
  };
}
