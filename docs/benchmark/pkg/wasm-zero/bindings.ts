...
export function bindWasmZero(wasm: any) {
  ...
  return {
    wasm,
    thunk(): void { wasm["__wasm_zero_thunk"](); },
    add(a: number, b: number): number { return wasm["__wasm_zero_add"](a, b); },
    fibonacci(n: number): number { return wasm["__wasm_zero_fibonacci"](n); },
    get_person(): Person { return call("__wasm_zero_get_person", 32, (dv, u8, p) => decode_Person(dv, u8, p), null, null, null); },
    get_scores(): Uint32Array { return call("__wasm_zero_get_scores", 8, (dv, u8, p) => rdVec(dv, p, Uint32Array), null, null, null); },
  };
}
