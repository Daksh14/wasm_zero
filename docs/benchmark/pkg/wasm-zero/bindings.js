...
export function bindWasmZero(wasm) {
  ...
  return {
    wasm,
    thunk() { wasm["__wasm_zero_thunk"](); },
    add(a, b) { return wasm["__wasm_zero_add"](a, b); },
    fibonacci(n) { return wasm["__wasm_zero_fibonacci"](n); },
    get_person() { return call("__wasm_zero_get_person", 32, (dv, u8, p) => decode_Person(dv, u8, p), null, null, null); },
    get_scores() { return call("__wasm_zero_get_scores", 8, (dv, u8, p) => rdVec(dv, p, Uint32Array), null, null, null); },
  };
}
