...
export function call_first_child_n_times(n: number, element: any): void;

export function call_first_child_structural_n_times(n: number, element: any): void;

export function call_foo_bar_n_times(n: number, foo: any): void;
 ...
 */
export function get_person(): any;

/**
 * Matches `bench_wasm_zero::get_scores` (1024 u32s).
 */
export function get_scores(): Uint32Array;

declare function thunk2(): void;
...
export interface InitOutput {
    ...
    readonly call_first_child_n_times: (a: number, b: number) => void;
    readonly call_first_child_structural_n_times: (a: number, b: number) => void;
    readonly call_foo_bar_n_times: (a: number, b: number) => void;
    ...
    readonly get_person: () => number;
    readonly get_scores: (a: number) => void;
    readonly thunk: () => void;
